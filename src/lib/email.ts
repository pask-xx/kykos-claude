...
export async function sendOtpEmail(
  ...
  const subject = `${APP_NAME} - Codice di verifica`;
  const html = `
      ...
      <div style="max-width: 480px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 32px; text-align: center;">
          <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 24px;">
            Ciao! Il tuo codice di verifica è:
          </p>
          <div style="background: #f3f4f6; border-radius: 12px; padding: 24px; margin: 24px 0;">
            <p style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #1f2937; margin: 0;">${otpCode}</p>
          </div>
          <p style="color: #6b7280; font-size: 14px; margin: 0;">
            Il codice scade tra <strong>${expiresInMinutes} minuti</strong>.
          </p>
