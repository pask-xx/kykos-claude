...
export default function IntermediaryReportsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'RESOLVED':
        return <span className="px-2 py-1 bg-success-100 text-success-700 text-xs rounded">Risolta</span>;
      case 'DISMISSED':
                  ...
                  {report.status === 'PENDING' && (
                    <div className="flex gap-2 mt-4">
                      <button
                        ...
                        className="px-4 py-2 bg-success-600 text-white rounded-lg hover:bg-success-700 font-medium text-sm disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        disabled={processing === report.id}
                        className="px-4 py-2 bg-error-600 text-white rounded-lg hover:bg-error-700 font-medium text-sm disabled:opacity-50"
                      >
                        Blocca oggetto
                      </button>
                      <button
