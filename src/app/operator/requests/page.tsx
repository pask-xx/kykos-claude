    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Non ci sono richieste da gestire al momento."
        />
      ) : (
        <div className="space-y-8">
          {/* Sezione "In attesa" - collassabile, warning */}
            ...
            >
              {pendingRequests.map((req) => {
                ...
                return (
                  <div
                    key={req.id}
                    className="bg-white p-4 rounded-xl shadow-sm border-2 border-warning-200 flex flex-col gap-3"
                  >
          ...
          {/* Sezione "Elaborate" - collassabile, success */}
